...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resource/css/fontawesome-free-5.15.4-web/css/all.css">
		...
		<div class="col-12">
			<form action="../12jstl/25process.jsp" method="post">
				<div class="form-group">
					<label for="titleInput1">책 제목</label> <input
						type="text" name="title" class="form-control"
						id="titleInput1"> <small
						id="emailHelp" class="form-text text-muted">책 제목을 입력해주세요.</small>
				</div>
				<div class="form-group">
